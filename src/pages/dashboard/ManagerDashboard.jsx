...
import { ResponsiveContainer, CartesianGrid, Tooltip, XAxis, YAxis, BarChart, Bar, Legend } from "recharts";
        ...
        <section className="rounded-xl border border-gray-200 p-5 bg-white">
          ...
          <Table
            ...
            data={recentTeamLeads.map((l) => ({
              ...
              campaign: l?.Campaign?.value || l?.Campaign?.label || "-",
        ...
        <section className="rounded-xl border border-gray-200 p-5 bg-white">
          ...
          <Table
            ...
            data={myAssignments.slice(0, 5).map((a) => ({
              ...
              status: a?.Lead?.LeadStatus?.value || a?.Lead?.LeadStatus?.label || "-",
              source: a?.Lead?.LeadSource?.value || a?.Lead?.LeadSource?.label || "-",
              campaign: a?.Lead?.Campaign?.value || a?.Lead?.Campaign?.label || "-",
