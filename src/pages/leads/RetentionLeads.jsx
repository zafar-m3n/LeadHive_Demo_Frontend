...
const RetentionLeads = () => {
  ...
  }, [page, limit, statusIds, sourceIds, campaignIds, orderBy, orderDir, debouncedSearch, assignedFrom, assignedTo]);
  ...
  }, [statusIds, sourceIds, campaignIds, orderBy, orderDir, assignedFrom, assignedTo, limit, page]);
